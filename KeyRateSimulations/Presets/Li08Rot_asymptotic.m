%Preset input for prepare-and-measure Li 2008 protocol

function [protocolDescription,channelModel,leakageEC,parameters,solverOptions] = Li08Rot_asymptotic()
...
function [protocolDescription,channelModel,leakageEC]=setDescription()
    ...
    protocolDescription=str2func('Li08RotLossyDescription');
    channelModel=str2func('Li08RotLossyChannel');
...
function parameters=setParameters()
    ...
    %parameters.scan.theta = (0:0.01:1)*pi; %(0:0.01:1)*pi;
    %parameters.scan.phi = (0:0.05:1)*pi;
...
function solverOptions=setOptions()
    ...
    solverOptions.optimizer.optimizerVerboseLevel = 3; %0:only output optimized result; 1:output a progress bar; 2:output at each function call
