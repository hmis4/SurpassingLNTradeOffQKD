%Preset input for prepare-and-measure Boileau protocol with 3 photons

function [protocolDescription,channelModel,leakageEC,parameters,solverOptions] = Boileau3_asymptotic()
...
function [protocolDescription,channelModel,leakageEC]=setDescription()
    ...
    protocolDescription=str2func('Boileau3LossyDescription');
    channelModel=str2func('Boileau3LossyChannel');
