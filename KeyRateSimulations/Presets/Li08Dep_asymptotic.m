...
function [protocolDescription,channelModel,leakageEC,parameters,solverOptions] = Li08Dep_asymptotic()
...
function [protocolDescription,channelModel,leakageEC]=setDescription()
    ...
    protocolDescription=str2func('Li08DepLossyDescription');
    channelModel=str2func('Li08DepLossyChannel');
